  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
        <div className="bg-gradient-to-r from-green-600 to-green-800 text-black p-6" style={{background: "#5ab15a"}}>
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="hover:bg-green-800 px-4 py-2 rounded-lg flex items-center"
              style={{background: "#7bc99e"}}
            >
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <select
                          ...
                          className="w-full px-3 py-2 border border-gray-300 rounded-md text-black focus:ring-2 focus:ring-green-500"
                        >
                      ...
                      <button
                        ...
                        className="w-full bg-green-600 text-black py-2 px-4 rounded-lg hover:bg-green-700 flex items-center justify-center"
                      >
